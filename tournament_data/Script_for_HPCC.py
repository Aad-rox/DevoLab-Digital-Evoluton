...
#SBATCH --output={log_dir}/job_{mu}_{ps}_{ts}.out
#SBATCH --job-name=job_{mu}_{ps}_{ts}

python3 data_collection_tournament.py --mutation_rate_ {mu} --population_size_ {ps} --tournament_size_ {ts}; """
